...
![status: v0.0.1-rc.2](https://img.shields.io/badge/status-v0.0.1--rc.2%20%C2%B7%20Gmail%20%2B%20IMAP-orange)
...
> **Pre-1.0 — v0.0.1-rc.2.** This is a release candidate: it works, but interfaces
